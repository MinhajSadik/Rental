...
const FrontCard: React.FC = () => {
  ...
  const handleContinue = () => {
    ...
    if (rawData !== null) {
      ...
      localStorage.setItem("signupData", JSON.stringify({...parsedData, IDCard: {...parsedData.IDCard, front: uploadedImage }}))
  ...
  return (
    <div className="space-y-16">
      <h2 className="text-4xl font-semibold text-secondary">Upload Front of your identify card</h2>
      <div className="grid grid-cols-2 items-center gap-14">
        <div className="bg-[#FAFAFA] min-h-[400px] p-14 rounded flex justify-center items-center">
          ...
          {
            !loading && <Image
            src={uploadedImage || "/images/placeholder_id_front_card.svg" }
