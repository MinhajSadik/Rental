    ...
    <>
      ...
      <div className="grid grid-cols-2 items-center gap-14">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <Link 
            className="bg-[#e3e8f0] max-w-[250px] w-full py-3.5 px-4 rounded font-medium text-secondary hover:bg-[#d4d9e2] transition duration-300 text-center"
            href="/signup/upload-image"
          >
            Continue
          </Link>
        </div>
